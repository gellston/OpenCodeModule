...
oc::variant oc::omodule_densenet_segmentation::initialize(oc::variant &inputs) {
...
oc::variant oc::omodule_densenet_segmentation::run(oc::variant &inputs) {
	variant outputs;
	...
	input_vec.push_back({ TF_GraphOperationByName(this->_graph, "model_densenet_segmentation_v1/input"), 0 });
	input_vec.push_back({ TF_GraphOperationByName(this->_graph, "model_densenet_segmentation_v1/phase"), 0 });
	output_vec.push_back({ TF_GraphOperationByName(this->_graph, "model_densenet_segmentation_v1/Sigmoid"), 0 });
...
oc::variant oc::omodule_densenet_segmentation::dispose() {
	variant output;
